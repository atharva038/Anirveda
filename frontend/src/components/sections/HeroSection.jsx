...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div
        className={`relative z-10 w-full max-w-5xl mx-auto p-8 sm:p-12 lg:p-16 text-center transition-all duration-700 ${
      ...
      >
        ...
        >
          {features.map((feature, index) => (
            <div
              key={index}
              className="p-6 bg-muted/20 border border-border rounded-xl transition-all duration-300 hover:scale-105 group cursor-pointer"
            >
        ...
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {stats.map((stat, index) => (
              <div
                key={index}
                className={`p-4 bg-muted/20 border rounded-xl transition-all duration-300 hover:scale-105 cursor-pointer ${
                  currentStat === index
